TODO transit to separate .el files and Cask
...
#+BEGIN_SRC emacs-lisp
    ...
    (add-hook 'magit-log-edit-mode-hook
     ...
     (eval-after-load 'magit '(progn
      ...
      (nmap "[k" 'git-gutter+-next-hunk)
      (nmap "]k" 'git-gutter+-previous-hunk)
...
#+BEGIN_SRC emacs-lisp
  ...
  (prodigy-define-service
    :name "10to8-sockjs"
    :command ". ~/.virtualenvs/Native/bin/activate && python manage.py run_sockjs_server"
    :cwd "~/10to8/Native/native/src/"
    :tags '(10to8))

  (prodigy-define-service
    :name "10to8-messaging"
    :command ". ~/.virtualenvs/Native/bin/activate && python manage.py run_messaging"
    :cwd "~/10to8/Native/native/src/"
    :tags '(10to8))
