...
(defun rainbow-blocks-depth-face (depth)
...
(defun rainbow-blocks-depth (loc)
...
(defun rainbow-blocks-propertize-delimiter (loc depth)
...
(defun rainbow-blocks-char-ineligible-p (loc)
